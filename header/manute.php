...
<html lang="pt-br">
<head>
        <title>Demadan Store</title>        <link rel="stylesheet" type="text/css" href="estilo.css">
    ...
    <header class="menu-principal">
        <div class="header">
            <ul class="ul">
                ...
                <!--<li><a href=""><img class="icfm" src="../logo/iconefeminino.png" width="5%" height="50%" alt="icone feminino" style="max-width: 100%"></a></li>-->
                ...
                <li><a href="../CLIENTE/deleta.php"><img class="carrinho" src="../Logo/configura.png" width="4%" heigth="4%"style="max-width: 100%;"></a></li>
            </ul>
        </div>
    </header>      
</body>
